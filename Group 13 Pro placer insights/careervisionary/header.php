			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="index.php">ProPlacer</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://localhost/careervisionary/login.php">Career Prediction</a>
                                <a href="http://localhost/careervisionary/courses.php">Courses</a>
                                <a href="http://localhost/careervisionary/blog.php">Knowledge Network</a>

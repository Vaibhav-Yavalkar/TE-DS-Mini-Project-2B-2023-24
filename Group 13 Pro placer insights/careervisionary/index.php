				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">ProPlacer</h1>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to ProPlacer</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">ProPlacer</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<a href="http://careerappapp-env.eba-mpfcdi2u.us-east-1.elasticbeanstalk.com/login.php"><h4>Career Prediction</h4></a>
								<?php else: ?>
					...
					<div class="col-md-6">
							...
							<?php
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									...
									<h2 class="white-text" style="font-size: 25px; width:700px ; margin-top:10px;">Your Placement Path Begins Here</h2>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About ProPlacer</h2>
							<p class="lead" style="font-size: 18px; font-style: italic; margin-top: 50px;">Education seekers get a personalised experience on our site, based on educational background and Placement interest, enabling them to make well informed course and Placement decisions. The decision making is empowered with easy access to detailed information on Placement choices, courses, exams, colleges, admission criteria, eligibility, placement statistics, rankings, reviews, scholarships, latest updates etc as well as by interacting with other ProPlacer users, experts, current students in colleges and alumni groups. We have introduced several student oriented products and tools like Placement Prediction, Knowledge Network, Daily Bytes, Blogs, Community discussion forum, and various Courses.</p>
